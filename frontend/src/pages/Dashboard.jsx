    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900 to-indigo-900 text-white p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div
            ...
            className="bg-gray-800 rounded-2xl p-6 shadow-xl hover:shadow-blue-500/20 transition-shadow duration-300 cursor-pointer">
        ...
        <div
            ...
            className="bg-gray-800 rounded-2xl p-6 shadow-xl hover:shadow-purple-500/20 transition-shadow duration-300 cursor-pointer"
        >
          <div className="flex items-center mb-4">
            <div className="p-2 bg-purple-500 rounded-lg mr-3">
              {/*  BookOpenIcon */}
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                  <path stroke-linecap="round" stroke-linejoin="round" d="M12 3v18M3 9h18m-6 3h6m-9-3h9m-9 3h3" />
                  <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 12h19.5m-19.5 0a9.75 9.75 0 0119.5 0m-19.5 0a9.75 9.75 0 0019.5 0" />
                </svg>
            </div>
            <h2 className="text-xl font-semibold">My Recipes</h2>
          </div>
          <p className="text-gray-400">Your own added recipes will appear here.</p>
        </div>
